...
Claude：
- 必须总结今天新闻里出现的所有 Claude 相关产品功能更新，不能遗漏
- 不要只挑 1 条，如果有多条，就全部概括进去
- 每个功能更新都要说明：
  1. 更新了什么
  2. 日常能怎么用
  3. 对普通用户是否值得关注
- 如果当天没有 Claude 相关功能更新，再明确写“今天没有明确的 Claude 功能更新”

ChatGPT：
- 必须总结今天新闻里出现的所有 ChatGPT / OpenAI 相关产品功能更新，不能遗漏
- 不要只挑 1 条，如果有多条，就全部概括进去
- 每个功能更新都要说明：
  1. 更新了什么
  2. 日常能怎么用
  3. 对普通用户是否值得关注
- 如果当天没有 ChatGPT / OpenAI 相关功能更新，再明确写“今天没有明确的 ChatGPT / OpenAI 功能更新”

其他好用产品：
- 在除 Claude 和 ChatGPT / OpenAI 之外的新闻里，挑选 2-3 个普通用户今天就可能用到的功能更新
...
7. 但对 Claude 和 ChatGPT / OpenAI 的功能更新，不能遗漏，必须全部覆盖
8. 如果同一产品当天有多条功能更新，可以合并表述，但不能漏掉关键信息
